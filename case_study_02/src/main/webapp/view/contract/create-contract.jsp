...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-9">
            <form method="post">
                <legend align="center">Create Contract</legend>
                <input type="hidden" name="action" value="create">
                <input type="hidden" name="contractId" value="${contractObj.getContractId()}">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="serviceId" class="form-select" id="serviceId">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="contractStartDate" class="form-control" id="contractStartDate"
                           value="${contractObj.getContractStartDate()}">
                </div>
                <div class="mb-3">
                    <label for="contractEndDate" class="form-label">Contract End Date</label>
                    <input type="date" name="contractEndDate" class="form-control" id="contractEndDate"
                           value="${contractObj.getContractEndDate()}">
                </div>
                <div class="mb-3">
                    <label for="contractDeposit" class="form-label">Contract Deposit</label>
                    <input type="text" name="contractDeposit" class="form-control" id="contractDeposit"
                           value="${contractObj.getContractDeposit()}">
                </div>
