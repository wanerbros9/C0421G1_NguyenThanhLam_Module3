    ...
    <div class="row">
        <div class="col-lg-12">
            <table class="table table-striped">
                ...
                <tbody>
                <c:forEach var="contract" items="${contractListServlet}">
                    <tr>
                        <th scope="row" style="text-align: center"><c:out value="${contract.getContractId()}"/></th>
                        <td style="text-align: center"><c:out value="${contract.getEmployeeId()}"/></td>
                        <td style="text-align: center"><c:out value="${contract.getCustomerId()}"/></td>
                        <td style="text-align: center"><c:out value="${contract.getServiceId()}"/></td>
                        <td style="text-align: center"><c:out value="${contract.getContractStartDate()}"/></td>
                        <td style="text-align: center"><c:out value="${contract.getContractEndDate()}"/></td>
                        <td style="text-align: center"><c:out value="${contract.getContractDeposit()}"/></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
