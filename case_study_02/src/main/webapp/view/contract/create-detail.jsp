...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-9">
            <form method="post">
                <legend align="center">Create Contract Detail</legend>
                <input type="hidden" name="action" value="createDetail">
                <input type="hidden" name="contractDetailId" value="${contractDetailObj.getContractDetailId()}">
                <div class="mb-3">
                    <label for="contractId" class="form-label">Contract Name</label>
                ...
                <div class="mb-3">
                    <label for="attachServiceId" class="form-label">Attach Service Name</label>
                    <select name="attachServiceId" class="form-select" id="attachServiceId">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="quantity" class="form-control" id="quantity"
                           value="${contractDetailObj.getQuantity()}">
                </div>
                <button type="submit" class="btn btn-primary">Create Contract Detail</button>
                <p>
                    <c:if test="${msg != null}">
                        ${msg}
                    </c:if>
